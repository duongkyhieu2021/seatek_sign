...
class OdooSession {
  ...
  ///Employee_id -> employee of current company
  final List<dynamic> employee_id;

  ///Employee_ids -> multi company
  final List<dynamic> employee_ids;
  ...
  static OdooSession fromJson(Map<String, dynamic> json) {
    return OdooSession(
      ...
      employee_ids: json['employee_ids'],
    );
  }
  ...
  OdooSession updateSessionId(String newSessionId) {
    return OdooSession(
      ...
      employee_ids: employee_id == '' ? [] : employee_ids,
    );
  }
  ...
  @override
  String toString() {
    return 'OdooSession {userName: $userName, userLogin: $userLogin, userId: $userId, companyId: $companyId, id: $id,employee_id:$employee_id,employee_ids:$employee_ids}';
  }
}
